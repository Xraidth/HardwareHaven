...
export const LineaCompraDTOSchema = Type.Object({
    nroLinea: Type.Optional(Type.Number({
        minimum: 1,
        errorMessage: {
    ...
    cantidad: Type.Optional(Type.Number({
        minimum: 1,
        errorMessage: {
    ...
    subTotal: Type.Optional(Type.Optional(Type.Number({
        errorMessage: {
            type: "El subtotal debe ser un número",
        },
    }))),
    compraId: Type.Optional(Type.Number({
        minimum: 0,
        errorMessage: {
...
//# sourceMappingURL=lineaCompra-typesSchema.js.map